...
try:
    ...
    print "CryptoPlus.Cipher.RC5 isn't available. You're probably using the Debian pycrypto version. Install the original pycrypto for RC5."
    raise
...
class RC5(BlockCipher):
    def __init__(self,key,mode,IV,counter,rounds,word_size,segment_size):
        cipher_module = CryptoPlus.Cipher.RC5.new
