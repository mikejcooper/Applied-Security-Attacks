...
def readParams( file ) :
    global N, k, B, e, l, c, count_interactions
...
if ( __name__ == "__main__" ) :
  ...
  # def oaep_decode2(m, l, N):
  #     l_hash = hashlib.sha1(l).digest()
  #     hLen = len(l_hash)
  #     # k = ceil(math.log(N, 256))
  #     k = len("00" + m) / 2
  #     m = i2osp_len(os2ip(m), k)
  #     # print os2ip(i2osp_len( os2ip(m), len(m) / 2 ))
  #
  #
  #     # m = i2osp_len( os2ip(m), k )
  #
